<div class="card">
  <div class="card-body">
    ...
    <form class="forms-sample" id="formEditPrestasi" action="{{ route('prestasi.update', $prestasi->id) }}" method="POST" enctype="multipart/form-data"  onsubmit="return confirm('Yakin update data?')">
      @csrf
      @method('PUT')
      <div class="row">
