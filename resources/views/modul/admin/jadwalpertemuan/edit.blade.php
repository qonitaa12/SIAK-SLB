<div class="card">
  <div class="card-body">
    ...
    <form class="forms-sample" id="formEditJadwalpertemuan" action="{{ route('jadwal_pertemuan.update', $jadwal_pertemuan->id) }}" method="POST" onsubmit="return confirm('Yakin update data?')">
      @csrf
      @method('PUT')
      <div class="row">
