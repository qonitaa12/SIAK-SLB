<div class="card">
  <div class="card-body">
    <p class="card-description text-muted">Masukkan data jadwal pelajaran</p>

    <form class="forms-sample" id="formTambahJadwalpelajaran" action="{{ route('jadwal_pelajaran.store') }}" method="POST" onsubmit="return confirm('Yakin kirim?')">
      @csrf
      <div class="row">
