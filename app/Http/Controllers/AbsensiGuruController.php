...
class AbsensiGuruController extends Controller
{
    ...
    {
        return view('modul.guru.absensi.index');
    }
    ...
    public function getData()
{
    ...
    public function create()
    {
        ...
        return view('modul.guru.absensi._form', compact('guru', 'daftarKelas'));
    }
    ...
    public function store(Request $request)
{
    ...
    public function edit($id)
    {
        ...
        return view('modul.guru.absensi.edit', compact('absensi', 'guru', 'kelas'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('absensi_guru.index')->with('success', 'Data absensi berhasil diperbarui.');
    }
