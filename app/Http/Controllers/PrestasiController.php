...
class PrestasiController extends Controller
{
    ...
    {
        return view('modul.admin.prestasi.index');
    }
    ...
    public function create()
    {
        ...
        return view('modul.admin.prestasi._form', compact('siswa'));
    }
    ...
    public function store(Request $request)
{
    ...
    public function edit($id)
    {
        ...
        return view('modul.admin.prestasi.edit', compact('prestasi','siswa'));
    }
