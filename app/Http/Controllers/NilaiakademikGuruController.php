...
class NilaiakademikGuruController extends Controller
{
    public function index()
    {
        return view('modul.guru.nilaiakademik.index');
    }
    ...
    public function create()
    {
        ...
        return view('modul.guru.nilaiakademik._form', compact('guru_mapel', 'kelas_siswa'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('modul.guru.nilaiakademik.edit', compact('nilai', 'guru_mapel', 'kelas_siswa'));
    }
