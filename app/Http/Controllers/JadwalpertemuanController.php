...
class JadwalpertemuanController extends Controller
{
    ...
    {
        return view('modul.admin.jadwalpertemuan.index');
    }
    ...
    public function create()
    {
        ...
        return view('modul.admin.jadwalpertemuan._form', compact('guru', 'siswaList'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('modul.admin.jadwalpertemuan.edit', compact('jadwal_pertemuan', 'guru', 'siswaList'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('jadwal_pertemuan.index')->with('success', 'Data jadwal pertemuan berhasil diperbarui.');
    }
